...
// cURL setup
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://srv504017.hstgr.cloud/api/v1/accounts/1/contacts/$contactID/conversations?status=open");
...
if (isset($responseData['payload'])) {
    foreach ($responseData['payload'] as $conversation) {
        ...
        if($meta['channel'] === 'Channel::Api'){
            ...
            $conversations[] = "<div class='conversation' data-id='$conversationId'>$conversationId-$displayName</div>";
        }
